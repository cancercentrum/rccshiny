...
test_that("loading legacyapp1-1.5.1 works", {
  skip_on_os("solaris")
...
test_that("loading legacyapp2-1.5.1 (sv) works", {
  skip_on_os("solaris")
...
test_that("loading legacyapp2-1.5.1 (en) works", {
  skip_on_os("solaris")
...
test_that("loading legacyapp3-1.5.1 works", {
  skip_on_os("solaris")
