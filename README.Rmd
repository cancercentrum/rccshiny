...
Man kan också manuellt hämta en komprimerad arkiv-fil med senaste släppta versionen från https://bitbucket.org/cancercentrum/rccshiny/get/master.tar.gz och installera med  
`install.packages("cancercentrum-rccshiny-COMMIT.tar.gz", repos = NULL, type = "source")`  
där COMMIT i Butbuckets namngivning av den komprimerade arkiv-filen baseras på identifieraren för sista ändringen i kodförrådet för den släppta versionen (se https://bitbucket.org/cancercentrum/rccshiny/commits/branch/master).
