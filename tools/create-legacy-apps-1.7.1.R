# remotes::install_bitbucket("cancercentrum/rccshiny", ref = "1.7.1", type = "binary")

library(rccShiny)

if (packageVersion("rccShiny") == "1.7.1") {

  # Create legacy0-1.7.1
  # Adopted from https://bitbucket.org/cancercentrum/rccshiny/src/1.6.0/R/rccShiny.R#lines-77
  rccShiny(
    data = rccShinyData,
    folder = "legacy0-1.7.1",
